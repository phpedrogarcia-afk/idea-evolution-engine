...
| [**ADR-012**](file:///c:/Users/phped/Documents/ProjetoFioIedeias/docs/DECISIONS-LEDGER.md#adr-012) | 2026-08-26 | **Proibição de Missões de Fundação por Inércia e Transição Obrigatória para o MVP** | `ACCEPTED` | Encerramento formal da Fase 0 e autorização do Simple Loop MVP. |
| [**ADR-013**](file:///c:/Users/phped/Documents/ProjetoFioIedeias/docs/DECISIONS-LEDGER.md#adr-013) | 2026-08-26 | **Institucionalização da Doutrina Operacional de Construção e Preservação de Fonte** | `ACCEPTED` | Adoção canônica da Doutrina Operacional com preservação da fonte v1.0. |
| [**ADR-014**](file:///c:/Users/phped/Documents/ProjetoFioIedeias/docs/DECISIONS-LEDGER.md#adr-014) | 2026-08-26 | **Exigência Obrigatória de Target Uncertainty e Stop Condition em Contratos de Tarefa** | `ACCEPTED` | Anti-Circle Rule: toda missão declara incerteza alvo e condição de parada. |
